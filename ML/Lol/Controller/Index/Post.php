 ...
 */
namespace ML\Lol\Controller\Index;
...
class Post extends \Magento\Contact\Controller\Index
{
    ...
    public function execute()
    {
        if (!$this->isPostRequest()) {
            return $this->resultRedirectFactory->create()->setPath('wholesale/index/index');
        }
        try {
        ...
        return $this->resultRedirectFactory->create()->setPath('wholesale/index');
    }
